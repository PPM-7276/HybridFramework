package com.mindbowser.utility;
...
/*
 * All the utilities needed for the framework is placed in this class including all JavascriptExecutor interface
 * 
 */

public class JavaScriptUtilitiy{
